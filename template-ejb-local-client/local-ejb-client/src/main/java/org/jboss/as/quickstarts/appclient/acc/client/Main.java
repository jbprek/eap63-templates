...
/**
 * A messagedriven EJB client to demonstrate the use of the JBoss application container
...
public class Main {
    ...
    public static void main(String args[]) throws NamingException {
        ...
        // the value might be NULL if we are running as a messagedriven Java program
